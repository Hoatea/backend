    ...
    <script>
        $(document).ready(function() {
            function tongsomathang() {
                $.ajax('/backend/backend/api/baocao-tongsomathang.php',{
            ...
            function tongsokhachhang() {
                $.ajax('/backend/backend/api/baocao-tongsokhachhang.php',{
                    success: function(data) {
                        var dataObj = JSON.parse(data);
                        var htmlString = `<h1>${dataObj.SoLuong}</h1>`;
            ...
            function tongsodonhang() {
                $.ajax('/backend/backend/api/baocao-tongsodonhang.php',{
                    success: function(data) {
                        var dataObj = JSON.parse(data);
                        var htmlString = `<h1>${dataObj.SoLuong}</h1>`;
            ...
            function tongsogopy() {
                $.ajax('/backend/backend/api/baocao-tongsogopy.php',{
                    success: function(data) {
                        var dataObj = JSON.parse(data);
                        var htmlString = `<h1>${dataObj.SoLuong}</h1>`;
            ...
            $('#refreshBaoCaoKhachHang').click(function(){
                tongsokhachhang();
            });
            $('#refreshBaoCaoDonHang').click(function(){
                tongsodonhang();
            });
            $('#refreshBaoCaoGopY').click(function(){
                tongsogopy();
            });
            ...
            function renderChartThongKeLoaiSanPham() {
                $.ajax({
                url: '/backend/backend/api/baocao-thongkeloaisanpham.php',
                type: "GET",
