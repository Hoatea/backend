    ...
    <div class="container">
        <div class="row">
            ...
            <main role="main" class="col-md-12 ml-sm-auto px-4 mb-2">
                ...
                ?>
                    <h2>Bạn đã đăng nhập rồi. <a href="/backend/backend/pages/index.php">Bấm vào đây để quay về trang chủ.</a></h2>
                <?php else : ?>
...
EOT;
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            echo '<script>location.href = "/backend/backend/pages/index.php";</script>';
                        } else {
